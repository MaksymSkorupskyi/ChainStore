...
from shop.views import ShopList, ShopEdit, ShopCreate, ShopDelete, ShopUpdate, CustomShopDetailView
...
urlpatterns = [
    ...
    re_path(r'^shop/(?P<pk>\d+|new)/edit$', ShopUpdate.as_view(), name='shop_edit'),
